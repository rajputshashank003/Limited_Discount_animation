        ...
        <div className="relative">
            ...
            <div className="rounded-[12px] bg-zinc-300 p-[10px] w-[300px] flex flex-col gap-[10px] ">
                <div className="grid grid-cols-4 gap-[10px]  ">
                    ...
                    <div onClick={handleClick} className="col-span-1 relative shadow-sm h-[60px] cursor-pointer shadow-gray-400 text-red-600 flex justify-center items-center rounded-[12px] bg-zinc-100 ">
